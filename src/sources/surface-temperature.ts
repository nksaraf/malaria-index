...
export default function getSurfaceTemperature(date_start, date_end, geometry) {
  var satellite = "L8";
  var use_ndvi = false;

  // get landsat collection with added variables: NDVI, FVC, TPW, EM, LST
  var LandsatColl = getCollection(
    satellite,
    date_start,
    date_end,
    geometry,
  ...
  return { image: LandSurfaceTempretureNormazlied };
}
...
function getCollection(landsat, date_start, date_end, geometry, use_ndvi) {
